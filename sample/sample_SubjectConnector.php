...
/**
 * Een nieuw SubjectConncetor object vereist een connectie-object als parameter.
 ...
 **/
$g = new SubjectConnector(clone $c);
...
try {
    ...
    echo "OK :) Bestand ontvangen, length: " . strlen($g->GetResults(5583));
