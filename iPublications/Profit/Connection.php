...
class Connection
{
    ...
    {
        if (isset($this->M_s_SoapCall_Username)) {
            unset($this->M_s_SoapCall_Username);
        }
    }

    final public function DropSoapCallPassword()
    {
        if (isset($this->M_s_SoapCall_Password)) {
            unset($this->M_s_SoapCall_Password);
        }
    }
    ...
    final public function SetAuthDomain($P_s_Domain)
    {
        ...
        if ($this->M_s_Domain !== '') {
            $this->SetAuthType(Connection::AUTH_NTLM);
        }
    }
    ...
    final private function SanitizeWebserviceURL($P_s_URL)
    {
        ...
        if (!preg_match("@^http@i", $L_s_URL)) {
            $L_s_URL = 'http://' . $L_s_URL;
        }
        if (preg_match("@\?wsdl$@i", $L_s_URL)) {
            $L_s_URL = preg_replace("@\?wsdl$@i", '', $L_s_URL);
        }
        if (preg_match("@\?wsdl@i", $L_s_URL)) {
            $L_s_URL = preg_replace("@[\?\&]wsdl\&(.+)@i", '?\\1', $L_s_URL);
        }
    ...
    final public function GetHTTPStatusText($P_i_StatusCode = 501)
    {
        ...
        switch ($P_i_StatusCode) {
            case 100:
                $L_s_StatusText = 'Continue';
                break;
            case 101:
                $L_s_StatusText = 'Switching Protocols';
                break;
            case 200:
                $L_s_StatusText = 'OK';
                break;
            case 201:
                $L_s_StatusText = 'Created';
                break;
            case 202:
                $L_s_StatusText = 'Accepted';
                break;
            case 203:
                $L_s_StatusText = 'Non-Authoritative Information';
                break;
            case 204:
                $L_s_StatusText = 'No Content';
                break;
            case 205:
                $L_s_StatusText = 'Reset Content';
                break;
            case 206:
                $L_s_StatusText = 'Partial Content';
                break;
            case 300:
                $L_s_StatusText = 'Multiple Choices';
                break;
            case 301:
                $L_s_StatusText = 'Moved Permanently';
                break;
            case 302:
                $L_s_StatusText = 'Moved Temporarily';
                break;
            case 303:
                $L_s_StatusText = 'See Other';
                break;
            case 304:
                $L_s_StatusText = 'Not Modified';
                break;
            case 305:
                $L_s_StatusText = 'Use Proxy';
                break;
            case 400:
                $L_s_StatusText = 'Bad Request';
                break;
            case 401:
                $L_s_StatusText = 'Unauthorized';
                break;
            case 402:
                $L_s_StatusText = 'Payment Required';
                break;
            case 403:
                $L_s_StatusText = 'Forbidden';
                break;
            case 404:
                $L_s_StatusText = 'Not Found';
                break;
            case 405:
                $L_s_StatusText = 'Method Not Allowed';
                break;
            case 406:
                $L_s_StatusText = 'Not Acceptable';
                break;
            case 407:
                $L_s_StatusText = 'Proxy Authentication Required';
                break;
            case 408:
                $L_s_StatusText = 'Request Time-out';
                break;
            case 409:
                $L_s_StatusText = 'Conflict';
                break;
            case 410:
                $L_s_StatusText = 'Gone';
                break;
            case 411:
                $L_s_StatusText = 'Length Required';
                break;
            case 412:
                $L_s_StatusText = 'Precondition Failed';
                break;
            case 413:
                $L_s_StatusText = 'Request Entity Too Large';
                break;
            case 414:
                $L_s_StatusText = 'Request-URI Too Large';
                break;
            case 415:
                $L_s_StatusText = 'Unsupported Media Type';
                break;
            case 500:
                $L_s_StatusText = 'Internal Server Error';
                break;
            case 501:
                $L_s_StatusText = 'Not Implemented';
                break;
            case 502:
                $L_s_StatusText = 'Bad Gateway';
                break;
            case 503:
                $L_s_StatusText = 'Service Unavailable';
                break;
            case 504:
                $L_s_StatusText = 'Gateway Time-out';
                break;
            case 505:
                $L_s_StatusText = 'HTTP Version not supported';
                break;
            default:
